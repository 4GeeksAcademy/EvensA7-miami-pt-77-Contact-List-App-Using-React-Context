...
export const postContact = async (dispatch, payload) => {
    ...
    let response = await fetch('https://playground.4geeks.com/contact/agendas/evensa7/contacts', {
        method: "POST",
        headers: { "Content-type": "application/json" },
        body: JSON.stringify({
            name: inputName,
...
export const updateContact = async (dispatch, payload) => {
    ...
    let response = await fetch(`https://playground.4geeks.com/contact/agendas/evensa7/contacts/${id}`, {
        method: "PUT",
        headers: { "Content-type": "application/json" },
        body: JSON.stringify({
            name: updatedName,
...
export const deleteContact = async (dispatch, payload) => {
    let response = await fetch(`https://playground.4geeks.com/contact/agendas/evensa7/contacts/${payload}`, {
        method: "DELETE",
        headers: { "Content-type": "application/json" },
    });
